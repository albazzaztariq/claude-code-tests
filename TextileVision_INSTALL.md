# TextileVision Installation Guide
...
```python
from TextileVision1_test import TextileVisionr

scraper = TextileVisionr(openai_api_key="your-key")
...
1. Check the code comments in `TextileVision1_test.py`
